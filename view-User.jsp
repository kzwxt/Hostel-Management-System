      ...
      <div class="home-content">
        ...
        <div class="sales-boxes">
          <div class="recent-sales box">
			...
			<ul class="details">
  				<li class="topic">:&emsp;<c:out value="${customer.customerid}"/></li>
  				<li class="topic">:&emsp;<c:out value="${customer.customer_name}"/> </li>
  				<li class="topic">:&emsp;<c:out value="${customer.customer_phone}"/></li>
  				<li class="topic">:&emsp;<c:out value="${customer.customer_ic}"/> </li>
  				<li class="topic">:&emsp;<c:out value="${customer.customer_email}"/></li>
  				<li class="topic">:&emsp;<c:out value="${customer.customer_address}"/> </li>
			</ul>
