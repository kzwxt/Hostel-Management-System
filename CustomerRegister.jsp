...
<head>
    <meta charset="utf-8">
    <title>Hostel - Registration Customer</title>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Book <span class="text-primary text-uppercase">Your Room</span></h1>
                </div>
                <div class="row g-5">
                    <div class="col-lg-6">
                        <div class="row g-3">
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="customer_name" required pattern="[A-Za-z\s]+" title="Please enter only alphabetic characters">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                           <input type="text" class="form-control" name="customer_ic" required pattern="\d{12}" maxlength="12" inputmode="numeric" title="Please enter a 12-digit identification card number">

                                            <label for="identity">Your IC</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
